      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Tell us about yourself so we can create your personalized health journey
          </p>
        </div>
        ...
        <div className="card max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-between">
              ...
              >
                {isLoading ? 'Creating Account...' : 'Create Account & Generate Goal'}
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>💡 We'll use AI to generate a personalized health goal based on your profile</p>
        </div>
      </div>
    </div>
  );
